...
public class Vampire extends Enemy {
    ...
    private final List<Vampire> vampiresForBattleLvl1 = Arrays.asList(
    ...
    private final List<Vampire> vampiresForBattleLvl2 = Arrays.asList(
    ...
    private final List<Vampire> vampireForBattleLvl3 = Arrays.asList(
